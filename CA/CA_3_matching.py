#take the cleaned up output, and select matching records based on name, address,
# and distance similarity

# geocode the candidate matches
import os, sys
from os.path import dirname, join, abspath
abs_path = "C:/Users/lpatterson/AnacondaProjects/Tribal_Master"
sys.path.insert(0, abs_path)
import functions.geocode_functions as gf
...
# load clean data set and compare matches
sos_df = pd.read_csv(abs_path + '/step_4_work/output/CA_results_geocoded.csv')
...
fda_df.to_csv('C:/Users/lpatterson/AnacondaProjects/Tribal_Master/step_4_work/' +
    'CA/CA_FDA_matches.csv',index=False)
